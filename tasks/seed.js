...
const business1 = await businesses.create(
    "Earth & Me", 
    "Wellness Shop",
...
//-------- business2
 const business2 = await businesses.create(
    "LES Ecology Center", 
...
//-------- business3
 const business3 = await businesses.create(
    "Le Botaniste", 
    "Vegan Restaurant",
...
//user1
const user1 = await users.createUsers(
"John",
"Doe",
"johnDoe@gmail.com",
"johnDoeABC",
...
//user2
const user2 = await users.createUsers(
    "Eli",
    "Grant",
    "eliGrant@gmail.com",
    "eliGrantABC",
...
//user3
    const user3 = await users.createUsers(
        "Alora",
        "Fraizer",
